...
clean-build: ## remove build artifacts
	...
	rm -f photostore/static/js/app.js
	rm -f photostore/static/js/runtime.js
	rm -f photostore/templates/jsfiles.html
	rm -f photostore/static/css/style.css
	rm -f photostore/static/css/utils.css
